...
\input{./pages/glossary.tex} % Include the file specifying the glossary / acronym entries
...
% A study was conducted to develop a model for predicting crop irrigation needs using soil moisture and weather data. The study used a neural network model to predict the irrigation needs of a crop. The model was trained using data from a soil moisture sensor and weather data from a weather station. The model was then used to predict the irrigation needs of a crop. The model was able to predict the irrigation needs of a crop with an accuracy of 95\%.~\parencite{crop_irrigation_needs_prediction}
