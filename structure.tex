...
\subsectionfont{\vspace{6pt}\centering\normalfont\scshape} % \section{} styling
\subsubsectionfont{\normalfont\bfseries} % \subsection{} styling
\paragraphfont{\normalfont\itshape} % \subsubsection{} styling

% ----------------------------------------------------------------------------------------
% 	CHANGE THAT SUBSECTIONS ARE THE MAIN SECTIONS
% ----------------------------------------------------------------------------------------
% Load the titlesec package
\usepackage{titlesec}

% Configure subsection numbering
...
\usepackage[backend=bibtex,style=numeric,bibstyle=numeric,sorting=nyt,firstinits=true,uniquename=init]{biblatex}
